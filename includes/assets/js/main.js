(function ($) {
  jQuery(document).ready(function () {jQuery('#menu-handle').click(function(){      jQuery(this).toggleClass('open');    });
    ...
    jQuery(window).load(function () {
      ...
      `);
      // $parent.find(".cd-dropdown").prepend(`
      ...
      // $parent.find(".cd-dropdown .cd-close").on("click", function (event) {
      //   event.preventDefault();
      //   toggleNav();
      // });
